...
public class StudentClassDTO {
    ...
    public StudentClassDTO(String classId, String className, String teacherName,
                          String schedule, String room, String status, int studentCount,
                          double averageGrade, int attendancePercentage) {
