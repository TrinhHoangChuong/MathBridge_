...
class TutorAPI {
  ...
  loadToken() {
    ...
    this.token =
      localStorage.getItem("mb_token") || localStorage.getItem("authToken");
  ...
  async getStudentReport(studentId, params = {}) {
    ...
    const endpoint = queryString
      ? `/reports/student/${studentId}?${queryString}`
  ...
  async getTeacherReport(teacherId, params = {}) {
    const queryString = new URLSearchParams(params).toString();
    const endpoint = queryString
      ? `/reports/teacher/${teacherId}?${queryString}`
  ...
  async getClassReport(classId, params = {}) {
    const queryString = new URLSearchParams(params).toString();
    const endpoint = queryString
      ? `/reports/class/${classId}?${queryString}`
  ...
  async finishAssignedStudent(idNv, studentId) {
    const endpoint = `/assigned-students/${studentId}/finish?idNv=${encodeURIComponent(
      idNv
    )}`;
    return await this.request(endpoint, {
      method: "PUT",
  ...
  async getConsultationSchedule(params = {}) {
    const queryString = new URLSearchParams(params).toString();
    const endpoint = queryString
      ? `/consultation-schedule?${queryString}`
  ...
  async updateConsultationContent(consultationId, content) {
    return await this.request(
      `/consultation-schedule/${consultationId}/content`,
      {
        method: "PUT",
  ...
  async startConsultation(consultationId) {
    return await this.request(
      `/consultation-schedule/${consultationId}/start`,
      {
        method: "POST",
      }
    );
  ...
  async saveConsultationReview(consultationId, reviewData) {
    return await this.request(
      `/consultation-schedule/${consultationId}/review`,
      {
        method: "POST",
